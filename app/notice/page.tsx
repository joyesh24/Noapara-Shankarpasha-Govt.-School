      ...
      >
        ...
        <div className="mb-6 relative">
          <input
            ...
            className="w-full p-3 pl-10 rounded-lg border border-orange-300 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-300 bg-white/80 backdrop-blur-sm"
            value={searchTerm}
        ...
        <AnimatePresence>
          {filteredNotices.map((notice) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 hover:shadow-2xl transition-all duration-500 mb-4 group"
            >
              <h2 
